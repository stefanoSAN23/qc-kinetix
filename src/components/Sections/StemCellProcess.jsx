...
const StemCellProcess = () => {
  ...
  const consultationImageRef = useRef(null);
  ...
  useEffect(() => {
    ...
    const refs = [
      consultationTitleRef, consultationTextRef, consultationImageRef,
      processTitleRef, processTextRef, processImageRef,
      afterTitleRef, afterTextRef, afterButtonRef, afterImageRef
    ];
    ...
    <>
      ...
      <section className="stem-cell-consultation-section">
        <div className="stem-cell-consultation-container">
          <div className="stem-cell-consultation-content">
            ...
            <div className="stem-cell-consultation-text animated fadeInDown" ref={consultationTextRef}>
          ...
          <div className="stem-cell-consultation-image animated fadeIn" ref={consultationImageRef}>
            <img
      ...
      <section className="stem-cell-process-section">
        <div className="stem-cell-process-container">
          <div className="stem-cell-process-image animated fadeIn" ref={processImageRef}>
            <img
          ...
          <div className="stem-cell-process-content">
            ...
            <div className="stem-cell-process-text animated fadeInDown" ref={processTextRef}>
      ...
      <section className="stem-cell-after-section">
        <div className="stem-cell-after-container">
          <div className="stem-cell-after-content">
            ...
            <div className="stem-cell-after-text animated fadeInDown" ref={afterTextRef}>
          ...
          <div className="stem-cell-after-image animated fadeIn" ref={afterImageRef}>
            <img
