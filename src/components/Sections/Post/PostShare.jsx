  ...
  return (
    <section className="post-share-section">
      <div className="post-share-container">
        <span className="post-share-label">Share the Post:</span>
        <div className="post-share-buttons">
          <button
            className="post-share-btn post-share-btn_facebook"
            onClick={() => handleShare('facebook')}
            aria-label="Share on facebook"
          >
            <span className="post-share-btn-icon">
          ...
          <button
            className="post-share-btn post-share-btn_x-twitter"
          ...
          <button
            className="post-share-btn post-share-btn_linkedin"
          ...
          <button
            className="post-share-btn post-share-btn_pinterest"
